      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12">
          ...
          <div className="relative">
            ...
            {/* Orange Box - Positioned beside and slightly elevated */}
            <div className="absolute -top-4 -right-4 lg:relative lg:top-0 lg:right-0 lg:mt-6">
              <div className="bg-gradient-to-r from-orange-500 to-red-500 p-6 sm:p-8 rounded-2xl text-white shadow-lg transform translate-y-2 hover:translate-y-1 transition-transform duration-200">
